...
class ModelFixtures extends Fixture implements DependentFixtureInterface
{
  ...
  public function load(ObjectManager $manager)
  {
    ...
    foreach ($modelsByMarque as $brandName => $modelNames) {

      $brand = $this->getReference('bra-' . $this->i);
      $brandId = $this->i;
      //var_dump("Brand ID : ".$brandId); 
      ...
      foreach ($modelNames as $modelName) {
        ...
        $this->addReference("mod-$this->i-" . $this->j, $model);

        // Add debugging statement
        //var_dump("Model Reference from modele: mod-".$this->i."-" . $this->j);
