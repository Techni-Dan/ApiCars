...
$modelsByMarque = [
  ...
  'Aston Martin' => ['AMV8', 'Bulldog', 'Cygnet', 'DB11', 'DB4', 'DB5', 'DB6', 'DB7', 'DB9', 'DB12', 'DBS', 'DBX', 'Legonda', 'One-77', 'Rapide', 'V12 Vantage', 'V8 Vantage', 'Vanquish', 'Virage', 'Volante', 'Zagato'],
  ...
  'Bugatti' => ['Centodieci', 'Chiron', 'Divo', 'EB 110', 'La Voiture Noire', 'Tourbillon', 'Veyron', 'W16 Mistral'],
  ...
  'Byd' => ['Atto', 'Destroyer 05', 'Dolphin', 'Frigate 05', 'Frigate 07', 'Han', 'Landing Ship', 'Sea Lion', 'Seal', 'Seal DM-i', 'Seal U', 'Seagull', 'Tang'],
  ...
  'Renault' => ['10', '11', '12', '14', '16', '18', '19', '20', '21', '25', '30', '4', '5', '8', '9', 'Alaskan', 'Arkana', 'Austral', 'Avantime', 'Captur', 'Captur II', 'Clio', 'Clio III', 'Clio V', 'Espace', 'Espace IV', 'Espace V', 'Espace VI', 'Express', 'Fluence', 'Fuego', 'Grand Espace', 'Grand Scenic', 'Kadjar', 'Kangoo', 'Kangoo III', 'Koleos', 'Laguna', 'Latitude', 'Master', 'Megane', 'Megane E-Tech', 'Modus', 'Rafale', 'Safrane', 'Scénic', 'Scénic E-Tech', 'Scénic RX4', 'Symbol', 'Symbioz', 'Taliant', 'Talisman', 'Trafic', 'Twingo', 'Twingo II', 'Twingo III', 'Twizy', 'Vel Satis', 'Wind', 'ZOE'],
  'Rivian' => ['R1S', 'R1T'],
...
function generateSql($modelsByMarque) 
{
  $brands = array_keys($modelsByMarque);
  $brandSql = "INSERT INTO `brand` (`id`, `name`) VALUES\n";
  $modelSql = "INSERT INTO `model` (`id`, `brand_id`, `name`) VALUES\n";
  $brandId = 1;

  foreach ($brands as $brandName) {
    $brandSql .= "(NULL, '$brandName'),\n";

    foreach ($modelsByMarque[$brandName] as $modelName) {
      $modelSql .= "(NULL, '$brandId', '$modelName'),\n"; 
    }
...
$sql = generateSql($modelsByMarque);
saveSqlToFile($sql, __DIR__ . '/Brands_&_Models.sql');
