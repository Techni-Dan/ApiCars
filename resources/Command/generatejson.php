...
function generatejson($modelsByMarque) 
{
  $jsonData = [];
  $modelId = 1;

  foreach ($modelsByMarque as $brandName => $models) {
    $brandData = [
      "brand" => $brandName,
      "models" => []
    ];
...
$jsonData = generatejson($modelsByMarque); // Get the JSON data
$jsonData = json_encode($jsonData, JSON_PRETTY_PRINT);
saveJsonToFile($jsonData, __DIR__ . '/Brands_&_Models.json');
//$i=$i-1;
